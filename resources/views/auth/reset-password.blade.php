<x-auth-layout>
    <div class="space-y-2">
        ...
        <p class="text-gray-600">Als u uw wachtwoord bent vergeten, kunt u het hier opnieuw instellen. Je ontvangt een e-mail met een link om uw wachtwoord opnieuw in te stellen.</p>
