            ...
            <tbody>
                @foreach($bodyCompositionMeasurements as $measurement)
                    <tr>
                        ...
                        <td class="text-center"><button wire:click="deleteBodyCompositionMeasurement({{ $measurement->id }})" class="text-xs bg-red-500 text-white p-2 rounded-md hover:bg-red-700"><i class="fas fa-trash"></i></button></td>
                    </tr>
                @endforeach
            </tbody>
        </table>
