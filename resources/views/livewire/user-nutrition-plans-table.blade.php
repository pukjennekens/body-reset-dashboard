            ...
            <tbody>
                @foreach($nutritionPlans as $nutritionPlan)
                    <tr>
                        ...
                        <td>
                            <button wire:click="$dispatch('openModal', {component: 'forms.nutrition-plan', arguments: {id: {{ $nutritionPlan->id }}}})"class="text-xs bg-primary text-white p-2 rounded-md hover:bg-green-600"><i class="fas fa-edit"></i></button>
